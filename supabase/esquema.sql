...
-- Una fila por (sala, ejercicio, alumno), que se pisa en cada verificación. Al
-- docente le sirve saber cómo está la clase *ahora* para decidir si sigue o si
-- para a explicar algo; guardar cada intento haría crecer la tabla sin darle
-- nada mejor. Tampoco se guarda el código: quién está trabado y en qué caso
-- alcanza para enseñar.
